...
function ShopListing() {
  ...
  const [shopsList, setShopsList] = useState(shopsdata);
        ...
        <div class="row mb-4 align-items-end mt-4">
          ...
          <div class="row align-items-end">
            <div className="col">
              ...
              <select
                placeholder="Shop Area" className="form-control"
                {...register("shoparea")}
              >
                {area.map((data, index) => {
            ...
            <div class="col">
              ...
              <select
                name="shopcategory" className="form-control"
            ...
            <div class="col">
              ...
              <select name="status" className="form-control" {...register("status")}>
          ...
          shopsList
            .filter((item) => {
              ...
              if (
                ...
                searchData.shoparea !== "" ||
                searchData.shopcategory !== "" || searchData.status !== ""
              ) {
                let showdata;
                if (
                  item.shoparea
                  ...
                  searchData.shoparea === "" && searchData.shopcategory === ""
                ) {
                  showdata = item;
                } else if (
                  item.shopcategory
